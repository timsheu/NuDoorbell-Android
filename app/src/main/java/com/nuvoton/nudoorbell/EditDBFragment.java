...
public class EditDBFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener, CustomDialogFragment.DialogFragmentInterface{
    @Override
    ...
    public interface EditDBInterface{
        void editNewDoorbell(String serial, String name, String type, String url);
    }

    public EditDBInterface mInterface;
    private final String TAG = "SetDBFragment";
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (key.compareTo("serial") == 0){
            ...
            mInterface.editNewDoorbell(serial, type, name, url);
