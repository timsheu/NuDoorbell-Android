...
public class SetDBFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener, CustomDialogFragment.DialogFragmentInterface{
    @Override
    ...
    public static SetDBFragment newInsatnce(Bundle bundle){
        ...
        SetDBFragment fragment = new SetDBFragment();
        return fragment;
    }
