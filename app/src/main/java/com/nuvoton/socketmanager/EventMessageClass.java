...
public class EventMessageClass {
    ...
    public class S_EVENTMSG_HEADER{
        long eMsgType;				//E_EVENTMSG_TYPE
        long u32MsgLen;			//include message header length
        public S_EVENTMSG_HEADER(){
        }
    }

    public class S_EVENTMSG_LOGIN_REQ{
        S_EVENTMSG_HEADER sMsgHdr = new S_EVENTMSG_HEADER(); //8 bytes
    ...
    public class S_EVENTMSG_LOGIN_RESP{
        S_EVENTMSG_HEADER sMsgHdr = new S_EVENTMSG_HEADER();
